...
fn firefox() -> String {
    ...
    let ver = vec![
        ...
        "65.0", "65.0.1", "64.0", "64.0.2", "63.0", "63.0.1", "63.0.3", "62.0", "62.0.2", "62.0.3",
        "61.0", "61.0.1", "61.0.2", "60.0", "60.0.1", "60.0.2", "60.1.0", "60.2.0", "60.2.1",
        "60.2.2", "60.3.0", "60.4.0", "60.5.0", "60.5.1", "60.5.2", "59.0", "59.0.1", "59.0.2",
        "59.0.3", "58.0", "58.0.1", "58.0.2", "57.0", "57.0.1", "57.0.2", "57.0.3", "57.0.4",
        "56.0", "56.0.1", "56.0.2", "55.0", "55.0.1", "55.0.2", "55.0.3", "54.0", "54.0.1", "53.0",
        "53.0.2", "53.0.3", "52.0", "52.0.1", "52.0.2", "52.1.0", "52.1.1", "52.1.2", "52.2.0",
        "52.2.1", "52.3.0", "52.4.0", "52.4.1", "52.5.0", "52.5.2", "52.5.3", "52.6.0", "52.7.0",
        "52.7.1", "52.7.2", "52.7.3", "52.7.4", "52.8.0", "52.8.1", "52.9.0", "51.0", "51.0.1",
        "50.0", "50.0.1", "50.0.2",
    ];
...
fn macos() -> String {
    let sub = format!(
        "10_{}_{}",
        rand::thread_rng().gen_range(10..=14),
...
impl Headers {
    ...
    pub fn empty() -> std::collections::HashMap<String, String> {
